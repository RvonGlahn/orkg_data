import pandas as pd
from data_processing.api_data.doi_finder import DoiFinder
from logs.my_logger import MyLogger
from data_processing.util import process_abstract_string
...
from data_processing.api_data.api_scheduler import APIScheduler
from data_processing.api_data.data_validation import DataValidation
...
class APIData:
    ...
    def get_semantic_scholar_data(self, doi: str, index: int) -> Dict:
        ...
        semantic_scholar_url = 'https://api.semanticscholar.org/v1/paper/' + doi
    ...
    def _scrape_data_from_semantic(self, index: int) -> Dict:
        ...
        try:
            ...
            logger.error(f"Exception in DOIFinder{e}", exc_info=True)
