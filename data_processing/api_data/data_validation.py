...
logger = MyLogger('data_validation').logger
...
class DataValidation:
    ...
    def validate_data(
        ...
        logger.info(f'Score: {validation_score}.  ORKG:{orkg_title}  API:{api_title}')
    ...
    def _author_validation(self, api_authors: List[str], orkg_authors: str) -> int:
        ...
        int
        """
        orkg_authors = orkg_authors.replace("'", "")
        orkg_authors = orkg_authors.replace(".", "")
        orkg_authors = orkg_authors.replace("[", "")
        orkg_authors = orkg_authors.replace("]", "")
        orkg_authors = orkg_authors.replace("et al", "")
        orkg_authors = orkg_authors.split(',')
